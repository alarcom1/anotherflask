"""Calculation and Addition, Multiplication, and Subctraction Classes"""
...
class Calculation:
    ...
    def convert_args_to_tuple_of_float(tuple_list):
        ...
        # then i make it a tuple again because i actually wont need to change the calculation
